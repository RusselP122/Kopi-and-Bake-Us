...
<div class="wrapper">
        ...
        <div id="buttons">
            ...
            <button class="button-value" onclick="filterProduct('Espresso Based')">Espresso Based</button>
            <button class="button-value" onclick="filterProduct('Milk Based')">Milk Based</button>
            <button class="button-value" onclick="filterProduct('Ice Blended')">Ice Blended</button>
            <button class="button-value" onclick="filterProduct('Frappuccino')">Frappuccino</button>
            <button class="button-value" onclick="filterProduct('Milk Tea')">Milk Tea</button>
            <button class="button-value" onclick="filterProduct('Thai Series')">Thai Series</button>
            <button class="button-value" onclick="filterProduct('Fruitea')">Fruitea</button>
            <button class="button-value" onclick="filterProduct('Soda Pop')">Soda Pop</button>
            <button class="button-value" onclick="filterProduct('Pasta')">Pasta</button>
            <button class="button-value" onclick="filterProduct('Panciteria')">Panciteria</button>
            <button class="button-value" onclick="filterProduct('Burger Meals')">Burger Meals</button>
            <button class="button-value" onclick="filterProduct('SandWhiches')">SandWhiches</button>
            <button class="button-value" onclick="filterProduct('Chicken Wings')">Chicken Wings</button>
        </div>
      <div id="products"></div>
    </div>
